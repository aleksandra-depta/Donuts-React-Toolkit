...
const App = () => {
  ...
  const milkShakeCategory = products.filter((item) => item.type === "milkshake");
    ...
    <Routes>
      <Route path='/' element={<Navigation />} >
        ...
        <Route path='/menu' element={<Menu />}>
          <Route path='' element={<MenuCards categories={ specialsCategory } />} />
          <Route path='donuts' element={<MenuCards categories={ [...donutsCategory,...specialsCategory] } />} />
          <Route path='coffee' element={<MenuCards categories={ coffeeCategory } />} />
          <Route path='milkshakes' element={<MenuCards categories={ milkShakeCategory }/>} />
        </Route>
