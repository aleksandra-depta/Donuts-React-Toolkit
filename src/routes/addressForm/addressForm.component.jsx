...
import {
  ...
  activeCartNavBtn,
  stepAccess,
} from "../../features/activeBtnSlice";
import { successForm } from "../../features/paymentSlice";
...
import { removePickUpId } from "../../features/locationSlice";
      ...
      <NavBtns>
        ...
        {pickUpId === "" ? (
          ...
          <Button
            ...
            onClick={() =>
              dispatch(activeAddressBtn("/shoppingCart/address/pickUp"))
            }
            active={activeAddressBtnPathname}
          >
            pick up
