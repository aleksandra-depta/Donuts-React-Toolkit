...
import { BtnBlackSmall, BtnBrownSmall, HeadingH3, HeadingH3Brown, TextSmall } from "../../styled";
import { CardComponent, Image, CardDescription, CardBottom, LogoContainer } from "./cardMenu.styles";
...
const CardMenu = ({ product }) => {
  ...
  return (
    <CardComponent>
      <Image src={require(`../../img/products/${ product.image }`)} />
      <CardDescription>
        <div>
        ...
        <CardBottom>
          ...
          { product.inCart === true ?
            <BtnBrownSmall onClick={() => dispatch(openDetailModal(product._id))} >
              <ion-icon size='large' name="cart-outline"></ion-icon>
            </BtnBrownSmall>
          :
            <BtnBlackSmall onClick={() => dispatch(openDetailModal(product._id))} >
              <ion-icon size='large' name="cart-outline"></ion-icon>
            </BtnBlackSmall>
          }
        </CardBottom>
