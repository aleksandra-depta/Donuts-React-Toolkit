...
import { activeCartNavBtn } from "../../features/activeBtn/activeBtnSlice";

const NavSteps = () => {

  const { cartNavBtns, activeCartBtnPathname } = useSelector((store) => store.activeBtn);
          ...
          : 
            el.link === "/shoppingCart/address" &&  pickUpId !== '' ? 
              <Number 
                ...
                onClick={() => dispatch(activeCartNavBtn('/shoppingCart/address'))}
                active={ activeCartBtnPathname }
