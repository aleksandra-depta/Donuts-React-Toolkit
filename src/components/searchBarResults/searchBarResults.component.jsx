...
import { ButtonContent, Content, FilteredContainer, IconClose } from "./searchBarResults.styles";
...
const SearchBarResults = () => {
  ...
  return (
    <FilteredContainer>
      ...
      :
        <Content>
          {filteredProducts.map((item) => <CardMenu key={ item._id } product={ item }/>)}
        </Content>
      }
      <ButtonContent>
        <IconClose onClick={() => {
