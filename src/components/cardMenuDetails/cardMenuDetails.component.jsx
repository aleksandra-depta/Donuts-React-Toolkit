        ...
        <Content>
          ...
          <Description>
            <TextContent>
              ...
              <LinkSmallGrey onClick={() => setShowMoreOpen(!showMoreOpen)}>
                See More
              </LinkSmallGrey>
              {showMoreOpen === true && (
                <>
                  <div>
                    ...
                    <RowConent>
                      {product.allergens.map((item) => (
                        <TextMedium key={item}>{item}</TextMedium>
                      ))}
                    </RowConent>
                  </div>
                  <div>
            ...
            <ButtonsContainer>
              ...
              <BtnBlackSmall onClick={() => dispatch(closeDetailModal())}>
                Menu
              </BtnBlackSmall>
